package com.animal.snail.common.utils;
...
import com.animal.snail.common.vo.TokenMember;
import com.animal.snail.common.vo.TokenUser;
...
import com.animal.snail.modules.base.service.DepartmentService;
...
public class SecurityUtil {
    ...
    public String getToken(String username, Boolean saveLogin) {
        ...
        if (StrUtil.isBlank(username)) {
            throw new SnailException("username不能为空");
        }
        Boolean saved = false;
    ...
    public User getCurrUser() {
        ...
        if (authentication == null || !authentication.isAuthenticated() || authentication.getName() == null
            ...
            throw new SnailException("未检测到登录用户");
        }
    ...
    public Member getCurrMember() {
        ...
        if (authentication == null || !authentication.isAuthenticated() || authentication.getName() == null
                || authentication instanceof AnonymousAuthenticationToken) {
            throw new SnailException("未检测到登录会员");
        }
