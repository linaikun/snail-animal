package com.animal.snail.config.interceptor;

import com.animal.snail.common.annotation.RateLimiter;
...
import com.animal.snail.config.properties.SnailIpLimitProperties;
import com.animal.snail.config.properties.SnailLimitProperties;
...
public class LimitRaterInterceptor extends HandlerInterceptorAdapter {
    ...
    @Autowired
    private SnailLimitProperties limitProperties;

    @Autowired
    private SnailIpLimitProperties ipLimitProperties;
