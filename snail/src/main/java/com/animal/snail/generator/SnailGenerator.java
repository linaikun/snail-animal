...
public class SnailGenerator {
     ...
     * 建议仅需修改
     */
    private static final String DESCRIPTION = "教练/老师管理";
     ...
     * (文件自动生成至该包下)
     */
    private static final String DAO_PACKAGE = "com.animal.snail.modules.wxapp.dao";
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.printf(System.getProperty("user.dir") + "/src/main/java/");
        // 生成代码
        generateCode(gt);
    ...
    public static String name(String name, boolean isFirstUpper) {
        ...
        if (StrUtil.isBlank(name)) {
            throw new SnailException("name不能为空");
        }
