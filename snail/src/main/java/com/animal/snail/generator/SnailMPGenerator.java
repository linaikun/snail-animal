package com.animal.snail.generator;

import com.animal.snail.generator.bean.Entity;
import com.animal.snail.generator.bean.Item;
...
public class SnailMPGenerator {
     ...
     * 下方请根据需要修改
     */
    private static final String TABLE_PRE = "w_";
     ...
     * (文件自动生成至该包下)
     */
    private static final String ENTITY_PACKAGE = "com.animal.snail.modules.wxapp.entity";

    /**
     * dao对应包 【注意修改后需到com.animal.snail.config.mybatisplus.MybatisPlusConfig配置你的mapper路径扫描】
     * (文件自动生成至该包下)
     */
    private static final String DAO_PACKAGE = "com.animal.snail.modules.wxapp.mapper";

    /**
     * service对应包
     * (文件自动生成至该包下)
     */
    private static final String SERVICE_PACKAGE = "com.animal.snail.modules.wxapp.service";

    /**
     * serviceImpl对应包
     * (文件自动生成至该包下)
     */
    private static final String SERVICE_IMPL_PACKAGE = "com.animal.snail.modules.wxapp.serviceimpl";

    /**
     * controller对应包
     * (文件自动生成至该包下)
     */
    private static final String CONTROLLER_PACKAGE = "com.animal.snail.modules.wxapp.controller";
    ...
    private static void generateCode(GroupTemplate gt) throws IOException {
        ...
        entity.setClassName(SnailGenerator.name(CLASS_NAME, true));
        entity.setTableName(TABLE_PRE + SnailGenerator.camel2Underline(CLASS_NAME));
        entity.setClassNameLowerCase(SnailGenerator.name(CLASS_NAME, false));
        ...
        // 创建文件
        String entityFileUrl = SYS_PATH + SnailGenerator.dotToLine(ENTITY_PACKAGE) + "/" + SnailGenerator.name(CLASS_NAME, true) + ".java";
        ...
        log.info(daoResult);
        // 创建文件
        String daoFileUrl = SYS_PATH + SnailGenerator.dotToLine(DAO_PACKAGE) + "/" + SnailGenerator.name(CLASS_NAME, true) + "Mapper.java";
        ...
        // 创建文件
        String serviceFileUrl = SYS_PATH + SnailGenerator.dotToLine(SERVICE_PACKAGE) + "/I" + SnailGenerator.name(CLASS_NAME, true) + "Service.java";
        ...
        // 创建文件
        String serviceImplFileUrl = SYS_PATH + SnailGenerator.dotToLine(SERVICE_IMPL_PACKAGE) + "/I" + SnailGenerator.name(CLASS_NAME, true) + "ServiceImpl.java";
        ...
        // 创建文件
        String controllerFileUrl = SYS_PATH + SnailGenerator.dotToLine(CONTROLLER_PACKAGE) + "/" + SnailGenerator.name(CLASS_NAME, true) + "Controller.java";
        ...
        // 创建文件
        String mapperXmlFileUrl = System.getProperty("user.dir") + "/src/main/resources/mapper/" + SnailGenerator.name(CLASS_NAME, true) + "Mapper.xml";
    ...
    private static void deleteCode(String className) {
        ...
        String entityFileUrl = SYS_PATH + SnailGenerator.dotToLine(ENTITY_PACKAGE) + "/" + SnailGenerator.name(className, true) + ".java";
        Files.delete(Paths.get(entityFileUrl));
        
        String daoFileUrl = SYS_PATH + SnailGenerator.dotToLine(DAO_PACKAGE) + "/" + SnailGenerator.name(className, true) + "Mapper.java";
        Files.delete(Paths.get(daoFileUrl));

        String serviceFileUrl = SYS_PATH + SnailGenerator.dotToLine(SERVICE_PACKAGE) + "/I" + SnailGenerator.name(className, true) + "Service.java";
        Files.delete(Paths.get(serviceFileUrl));

        String serviceImplFileUrl = SYS_PATH + SnailGenerator.dotToLine(SERVICE_IMPL_PACKAGE) + "/I" + SnailGenerator.name(className, true) + "ServiceImpl.java";
        Files.delete(Paths.get(serviceImplFileUrl));

        String controllerFileUrl = SYS_PATH + SnailGenerator.dotToLine(CONTROLLER_PACKAGE) + "/" + SnailGenerator.name(className, true) + "Controller.java";
        Files.delete(Paths.get(controllerFileUrl));

        String mapperXmlFileUrl = System.getProperty("user.dir") + "/src/main/resources/mapper/" + SnailGenerator.name(className, true) + "Mapper.xml";
    ...
    private static void generateMPlus(GroupTemplate gt) {
        ...
        String path = ENTITY_PACKAGE + "." + SnailGenerator.name(CLASS_NAME, true);
        ...
        for (int i = 0; i < fields.length; i++) {
            ...
            item.setUpperName(SnailGenerator.name(fieldName, true));
            item.setLowerName(SnailGenerator.name(fieldName, false));
            item.setLineName(SnailGenerator.camel2Underline(fieldName));
