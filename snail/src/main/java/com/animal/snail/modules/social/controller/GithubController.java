...
import com.animal.snail.modules.social.vo.GithubUserInfo;
...
@RequestMapping("/snail/social/github")
@Controller
public class GithubController {

    @Value("${snail.social.github.clientId}")
    private String clientId;

    @Value("${snail.social.github.clientSecret}")
    private String clientSecret;

    @Value("${snail.social.github.callbackUrl}")
