package com.animal.snail.modules.file.manage.impl;
...
import com.animal.snail.modules.file.manage.FileManage;
...
public class QiniuFileManage implements FileManage {
    ...
    public OssSetting getOssSetting() {
        ...
        if (setting == null || StrUtil.isBlank(setting.getValue())) {
            throw new SnailException("您还未配置七牛云对象存储");
        }
    ...
    public String inputStreamUpload(InputStream inputStream, String key, MultipartFile file) {
        ...
        try {
            ...
            throw new SnailException("上传文件出错，请检查七牛云配置，" + r.toString());
        }
    }
    ...
    public String renameFile(String fromKey, String toKey) {
        ...
        try {
            ...
            throw new SnailException("重命名文件失败，" + ex.response.error);
        }
    }
    ...
    public String copyFile(String fromKey, String toKey) {
        ...
        try {
            ...
            throw new SnailException("复制文件失败，" + ex.response.error);
        }
    }
    ...
    public void deleteFile(String key) {
        ...
        try {
            ...
            throw new SnailException("删除文件失败，" + ex.response.error);
        }
    }
}
