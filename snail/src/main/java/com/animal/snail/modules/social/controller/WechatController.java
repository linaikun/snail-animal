...
import com.animal.snail.modules.social.vo.WechatUserInfo;
...
@RequestMapping("/snail/social/wechat")
@Controller
public class WechatController {

    @Value("${snail.social.wechat.appId}")
    private String appId;

    @Value("${snail.social.wechat.appSecret}")
    private String appSecret;

    @Value("${snail.social.wechat.callbackUrl}")
