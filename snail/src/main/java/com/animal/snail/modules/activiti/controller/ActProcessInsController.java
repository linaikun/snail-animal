package com.animal.snail.modules.activiti.controller;
...
import com.animal.snail.config.properties.ActivitiExtendProperties;
import com.animal.snail.modules.activiti.controller.modeler.DefaultProcessDiagramGenerator;
...
import com.animal.snail.modules.activiti.vo.ActPage;
import com.animal.snail.modules.activiti.vo.HistoricProcessInsVo;
import com.animal.snail.modules.activiti.vo.ProcessInsVo;
...
@RequestMapping("/snail/actProcess")
@Transactional
public class ActProcessInsController {
    ...
    public void getHighlightImg(@ApiParam("流程实例id") @PathVariable String id,
        ...
        try {
            ...
            throw new SnailException("读取流程图片失败");
        }
    }
