...
import com.animal.snail.modules.social.vo.WokWechatUserInfo;
 ...
 */
@Slf4j
@Api(description = "企业微信登录接口")
@RequestMapping("/snail/social/workwechat")
@Controller
public class WorkWechatController {

    @Value("${snail.social.workwechat.appId}")
    private String appId;

    @Value("${snail.social.workwechat.agentId}")
    private String agentId;

    @Value("${snail.social.workwechat.appSecret}")
    private String appSecret;

    @Value("${snail.social.workwechat.callbackUrl}")
