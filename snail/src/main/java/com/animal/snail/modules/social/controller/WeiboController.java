...
import com.animal.snail.modules.social.vo.WeiboUserInfo;
...
@RequestMapping("/snail/social/weibo")
@Controller
public class WeiboController {

    @Value("${snail.social.weibo.appKey}")
    private String appKey;

    @Value("${snail.social.weibo.appSecret}")
    private String appSecret;

    @Value("${snail.social.weibo.callbackUrl}")
