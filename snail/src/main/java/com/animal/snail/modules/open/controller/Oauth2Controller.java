...
import com.animal.snail.common.constant.OAuthConstant;
...
import com.animal.snail.common.utils.NameUtil;
...
import com.animal.snail.modules.open.vo.Oauth2TokenInfo;
...
public class Oauth2Controller {
    ...
    private Client getClient(String client_id) {
        ...
        if (client == null) {
            throw new SnailException("客户端client_id不存在");
        }
        return client;
    }
}
