...
package com.animal.snail.modules.activiti.controller.modeler;
...
public class DefaultProcessDiagramGenerator implements ProcessDiagramGenerator {
    ...
    protected void drawActivity(DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode, List<String> highLightedActivities, List<String> highLightedFlows, double scaleFactor) {
        DefaultProcessDiagramGenerator.ActivityDrawInstruction drawInstruction = (DefaultProcessDiagramGenerator.ActivityDrawInstruction) this.activityDrawInstructions.get(flowNode.getClass());
        boolean highLighted;
    ...
    protected void drawArtifact(DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, Artifact artifact) {
        DefaultProcessDiagramGenerator.ArtifactDrawInstruction drawInstruction = (DefaultProcessDiagramGenerator.ArtifactDrawInstruction) this.artifactDrawInstructions.get(artifact.getClass());
        if (drawInstruction != null) {
