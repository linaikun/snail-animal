...
import com.animal.snail.modules.activiti.service.ActModelService;
...
@RequestMapping(value = "/snail/actModel")
@Transactional
public class ActModelController {
    ...
    public void export(@PathVariable String id, HttpServletResponse response) {
        ...
        try {
            ...
            if (nodeBytes == null) {
                throw new SnailException("导出失败，模型数据为空");
            }
            ...
            log.error(e.toString());
            throw new SnailException("导出模型出错");
        }
    }
