package com.animal.snail.modules.quartz.controller;
...
import com.animal.snail.modules.quartz.service.QuartzJobService;
...
@RequestMapping("/snail/quartzJob")
@Transactional
public class QuartzJobController {
    ...
    public Result<Object> pauseJob(QuartzJob job) {
        ...
        try {
            ...
            throw new SnailException("暂停定时任务失败");
        }
    ...
    public Result<Object> resumeJob(QuartzJob job) {
        ...
        try {
            ...
            throw new SnailException("恢复定时任务失败");
        }
        job.setStatus(CommonConstant.STATUS_NORMAL);
        quartzJobService.update(job);
    ...
    public void add(String jobClassName, String cronExpression, String parameter) {
        ...
        try {
            ...
            throw new SnailException("创建定时任务失败");
        } catch (Exception e) {
            throw new SnailException("后台找不到该类名任务");
        }
    }
    ...
    public void delete(String jobClassName) {
        ...
        try {
            ...
            throw new SnailException("删除定时任务失败");
        }
    }
