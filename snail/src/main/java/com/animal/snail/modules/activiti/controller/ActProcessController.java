...
import com.animal.snail.modules.activiti.entity.*;
import com.animal.snail.modules.activiti.service.*;
...
public class ActProcessController {
    ...
    public void exportResource(@ApiParam("流程定义id") @RequestParam String id,
        ...
        if (ActivitiConstant.RESOURCE_TYPE_XML.equals(type)) {
            ...
            throw new SnailException("类型type不正确");
        }
        ...
        try {
            ...
            throw new SnailException("导出部署流程资源失败");
        }
    }
