...
import com.animal.snail.common.utils.HibernateProxyTypeAdapter;
...
import com.animal.snail.modules.base.dao.mapper.DeleteMapper;
...
import com.animal.snail.modules.base.service.RoleDepartmentService;
...
@RequestMapping("/snail/department")
...
public class DepartmentController {
    ...
    public void deleteRecursion(String id, String[] ids) {
        ...
        if (list != null && list.size() > 0) {
            throw new SnailException("删除失败，包含正被用户使用关联的部门");
        }
        // 获得其父节点
