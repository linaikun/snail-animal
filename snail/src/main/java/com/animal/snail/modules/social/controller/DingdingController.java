 ...
 */
@Slf4j
@Api(description = "钉钉登录接口")
@RequestMapping("/snail/social/dingding")
@Controller
public class DingdingController {

    @Value("${snail.social.dingding.appId}")
    private String appId;

    @Value("${snail.social.dingding.appSecret}")
    private String appSecret;

    @Value("${snail.social.dingding.callbackUrl}")
