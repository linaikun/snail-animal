      ...
      <Layout>
        ...
        >
          <div v-show="currName == '1-0'">
            ...
            如果你觉得上方Snail提供的动画不明显，你还可以使用iView官方自带的顶部
            <a
          ...
          <div v-show="currName == '3-1'">
            <Alert type="info" show-icon>
              ...
              封装，已配置好图片上传(上传至Snail文件服务或Base64)、表情包。扩展编辑HTML代码、全屏预览、清空、XSS攻击过滤等。
            </Alert>
            ...
            <h3 class="article">样式冲突</h3>
            在 <code>FormItem</code> 中使用时，建议加上
            <code>class="form-wangEditor"</code>。参考代码生成器中的用法。
            <h3 class="article">props</h3>
            <Table
              :columns="props"
              :data="data30"
          ...
          <div v-show="currName == '3-2'">
            <Alert type="info" show-icon>
              ...
              <a href="https://github.com/quilljs/quill" target="_blank"
                >quill</a
              >
              封装。已配置好中文、图片上传(上传至Snail文件服务或Base64)。扩展编辑HTML代码、全屏预览、清空、XSS攻击过滤等。
            </Alert>
            ...
            <h3 class="article">样式冲突</h3>
            在 <code>FormItem</code> 中使用时，建议加上
            <code>class="form-quill"</code>。参考代码生成器中的用法。
            <h3 class="article">props</h3>
            <Table
              :columns="props"
              :data="data33"
...
<script>
import iconChoose from "@/views/my-components/snail/icon-choose";
import countDownButton from "@/views/my-components/snail/count-down-button";
import dict from "@/views/my-components/snail/dict";
import departmentChoose from "@/views/my-components/snail/department-choose";
import departmentTreeChoose from "@/views/my-components/snail/department-tree-choose";
import userChoose from "@/views/my-components/snail/user-choose";
import uploadPicInput from "@/views/my-components/snail/upload-pic-input";
import uploadPicThumb from "@/views/my-components/snail/upload-pic-thumb";
import fileUpload from "@/views/my-components/snail/file-upload";
import checkPassword from "@/views/my-components/snail/check-password";
import setPassword from "@/views/my-components/snail/set-password";
import customList from "@/views/my-components/snail/custom-list";
import userSelect from "@/views/my-components/snail/user-select";
import editor from "@/views/my-components/snail/editor";
import quill from "@/views/my-components/snail/quill";
import processChoose from "@/views/my-components/snail/process-choose";
import processStart from "@/views/my-components/snail/process-start";
import processCancel from "@/views/my-components/snail/process-cancel";
export default {
    ...
    return {
      ...
      data30: [
        ...
        },
        {
          name: "base64",
          desc:
            "是否使用base64保存图片，默认false上传至Snail配置的文件存储服务中，不推荐使用base64存储",
          type: "Boolean",
          value: "false",
        },
        {
