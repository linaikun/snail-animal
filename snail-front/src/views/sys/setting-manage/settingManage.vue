              ...
              >
                ...
                <div v-if="oss.serviceName != 'LOCAL_OSS'">
                  ...
                  >
                    ...
                    >
                      <Option
                        v-for="(item, i) in dictBucketRegions"
                        :key="i"
                        :value="item.value"
                        >{{ item.title }}</Option
                      >
              ...
              >
                ...
                <FormItem label="模版CODE" prop="templateCode">
                  <Input
                    ...
                    placeholder="请输入场景对应短信模版CODE，例如SMS_123456789"
                    style="width: 380px"
                  />
                </FormItem>
                <FormItem>
                ...
                <FormItem label="应用部署域名" prop="domain">
                  <Tooltip placement="right" content="拼接部分资源访问链接使用">
                    <Input
                      ...
                      placeholder="请输入应用部署域名前缀，如http://snail.snail.cn"
                      style="width: 380px"
                    />
                  </Tooltip>
                </FormItem>
                <FormItem label="单点登录域名" prop="ssoDomain">
                  ...
                  >
                    <Input
                      ...
                      placeholder="请输入应用部署一级域名，如snail.cn"
                      style="width: 380px"
                    />
                  </Tooltip>
                </FormItem>
  ...
  data() {
    return {
      ...
      ossValidate: {
        ...
        endpoint: [{ required: true, message: "不能为空", trigger: "change" }],
        bucket: [{ required: true, message: "不能为空", trigger: "change" }],
      },
      smsValidate: {
        // 表单验证规则
        serviceName: [{ required: true, message: "请选择", trigger: "change" }],
      ...
      getOssSet(v).then((res) => {
        ...
        if (res.result) {
          ...
          if (this.oss.serviceName == "LOCAL_OSS") {
            this.oss.http = "http://";
            this.oss.endpoint = "127.0.0.1:9999/snail/file/view";
          }
          this.changedOssSK = true;
        }
      });
