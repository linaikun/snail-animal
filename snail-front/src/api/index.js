...
// Vaptcha离线验证接口
export const vaptchaOffline = "/snail/common/vaptcha/offline"
// 高德地图key
export const amapKey = ""
// 文件上传接口
export const uploadFile = "/snail/upload/file"
// 验证码渲染图片接口
export const drawCodeImage = "/snail/common/captcha/draw/"
// 获取菜单
export const getMenuList = "/snail/permission/getMenuList"
// 获取数据字典
export const getDictData = "/snail/dictData/getByType/"
// Websocket
...
export const getCourseListList = (params) => {
    return getRequest('/wxapp/courseList/getByCondition', params)
}
// 添加课程列表
export const addCourseList = (params) => {
    return postRequest('/wxapp/courseList/save', params)
}
// 编辑课程列表
export const editCourseList = (params) => {
    return putRequest('/wxapp/courseList/update', params)
}
// 删除课程列表
...
export const getAllCurriculum = (params) => {
    return getRequest('/wxapp/curriculum/getAll', params)
}
...
// 添加门店管理
export const addSalesroom = (params) => {
    return postRequest('/wxapp/salesroom/save', params)
}
// 编辑门店管理
export const editSalesroom = (params) => {
    return putRequest('/wxapp/salesroom/update', params)
}
// 删除门店管理
export const deleteSalesroom = (params) => {
    return postRequest('/wxapp/salesroom/delByIds', params)
}

// 分页获取通用及条款说明数据
export const getClausedescriptionList = (params) => {
    return getRequest('/wxapp/clausedescription/getByCondition', params)
}
// 添加通用及条款说明
export const addClausedescription = (params) => {
    return postRequest('/wxapp/clausedescription/save', params)
}
// 编辑通用及条款说明
export const editClausedescription = (params) => {
    return putRequest('/wxapp/clausedescription/update', params)
}
// 删除通用及条款说明
export const deleteClausedescription = (params) => {
    return postRequest('/wxapp/clausedescription/delByIds', params)
}

// 分页获取公司基本说明数据
export const getBasicsetupList = (params) => {
    return getRequest('/wxapp/basicsetup/getByCondition', params)
}
// 添加公司基本说明
export const addBasicsetup = (params) => {
    return postRequest('/wxapp/basicsetup/save', params)
}
// 编辑公司基本说明
export const editBasicsetup = (params) => {
    return putRequest('/wxapp/basicsetup/update', params)
}
// 删除公司基本说明
export const deleteBasicsetup = (params) => {
    return postRequest('/wxapp/basicsetup/delByIds', params)
}
